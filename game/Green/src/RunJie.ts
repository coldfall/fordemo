 ...
 *
 */
class RunJie extends eui.Group{
    ...
    private mcrun:egret.MovieClip;
    private mcjump:egret.MovieClip;
    private mcfly:egret.MovieClip;
    private mchurry:egret.MovieClip;
    private mcfall:egret.MovieClip;

    private mybmp:eui.Image;
