 ...
 *
 */
class IndexView extends eui.Component{
    private r1:eui.Image;
    private r2: eui.Image;
    private r3: eui.Image;
    private rbig: eui.Image;
    
    private ani1: eui.Image;
    private ani2: eui.Image;
    private ani3: eui.Image;
    private ani4: eui.Image;
    private word1: eui.Image;
