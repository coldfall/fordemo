 ...
 *
 */
var FinishFailView = (function (_super) {
    __extends(FinishFailView, _super);
    function FinishFailView() {
        _super.call(this);
        this.addEventListener(eui.UIEvent.COMPLETE, this.uiLoaded, this);
        this.skinName = "resource/gameskins/FinishFailViewSkin.exml";
    }
    var d = __define,c=FinishFailView,p=c.prototype;
    p.uiLoaded = function () {
    ...
    return FinishFailView;
}(eui.Component));
egret.registerClass(FinishFailView,'FinishFailView');
